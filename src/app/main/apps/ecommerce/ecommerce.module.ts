...
import { EcommerceBuildComponent } from 'app/main/apps/ecommerce/ecommerce-build/ecommerce-build.component';
...
const routes: Routes = [
  ...
  {
    path: 'build',
    component: EcommerceBuildComponent,
    resolve: {
      ecommerce: EcommerceService
    },
    data: { animation: 'EcommerceBuildComponent' }
  },
];
